...
description: Review git changes for correctness, security, SOLID design, performance, reliability, and removal opportunities. Use when the user asks for a code review, risk audit, or structured findings without implementation.
---
